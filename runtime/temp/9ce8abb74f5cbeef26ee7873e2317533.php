<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:45:"./application/admin/view/order/offlists2.html";i:1566111556;s:61:"/www/wwwroot/nouser/application/admin/view/common/header.html";i:1568000924;s:59:"/www/wwwroot/nouser/application/admin/view/common/menu.html";i:1562208198;s:61:"/www/wwwroot/nouser/application/admin/view/common/footer.html";i:1561019635;s:62:"/www/wwwroot/nouser/application/admin/view/order/offedit2.html";i:1561019636;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
        ...
        <div class="col-md-12">
          <div class="panel panel-default">
                <div class="panel-body">
                    <form action="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/offlists2.html" method="get" autocomplete="off" id="form">
                        <?php if($_SESSION['role_id']==1){?>
                    <div class="col-lg-1">
                        <h5>所属业务员</h5>
                    ...
                    <div class="col-lg-1">
                        ...
                        <div class="form-group">
                            <select class="form-control" name="status2">
                                ...
                                <option value="<?php echo $k; ?>" <?php if($k==$status2){ echo 'selected';}?>><?php echo $v; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="panel panel-default" style="padding-top:15px;">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8" id="typeText" style="padding-top:7px;"></div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">异常信息</label>
                            <div class="col-sm-8">
                                <input type="hidden" class="form-control" name="exceptioninfo" value="">
                                <textarea class="form-control" disabled name="exceptioninfo2"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-3">
                                <input type="hidden" class="form-control" name="id" value="">
                                <input type="hidden" class="form-control" id="status2" name="status2" value="">
    ...
    function edit2(id,status2){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                $("[name=exceptioninfo2]").val(res.exceptioninfo);
            }
        });
    }
