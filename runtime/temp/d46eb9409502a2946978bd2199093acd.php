<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./application/merchant/view/merchant/register.html";i:1573119794;}*/ ?>
<!DOCTYPE HTML>
<html lang="zxx">
<head>
...
<div class="sub-main-w3">
    <form action="" name="" autocomplete="off" id="dx_form">
        ...
        <div class="form-style-agile">
            ...
            <input type="text" name="weixin" placeholder="请输入微信号" required="">
        </div>
        <div class="form-style-agile">
            <label>
                <i class="fas fa-unlock-alt"></i>
            ...
            <input type="text" name="regcode" placeholder="请输入入驻码" required="">
        </div>
        <div class="form-style-agile">
            <label>
                <i class="fas fa-unlock-alt"></i>
            ...
            <select style="width: 100%;    padding: 15px 15px;" name="aid">
                <option>请选择</option>
        ...
        <div class="wthree-text">
            <ul>
                <li style="font-size: 18px;">
                    <a href="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/login.html">返回登录</a>
                </li>
            </ul>
        </div>
        <!-- checkbox -->
...
<script type="text/javascript">
    ...
    $("#send").on('click',function(){
        ...
        $.ajax({
            type:'POST',
            cache:false,
            url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_send_register.html',
            dataType:'text',
            data:"mobile="+mobile,
    ...
    $("#sub").bind('click',function(){
        ...
        $.ajax({
            type:'POST',
            cache:false,
            url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_register.html',
            dataType:'text',
