<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:48:"./application/admin/view/adminoffline/lists.html";i:1564113000;s:61:"/www/wwwroot/nouser/application/admin/view/common/header.html";i:1568000924;s:59:"/www/wwwroot/nouser/application/admin/view/common/menu.html";i:1562208198;s:61:"/www/wwwroot/nouser/application/admin/view/common/footer.html";i:1561019635;s:64:"/www/wwwroot/nouser/application/admin/view/adminoffline/add.html";i:1561019636;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8"> 
          ...
          <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-md-12 col-lg-1">
                        <h5>操作</h5>
                        <div class="form-group">
                            <button class="btn btn-default" data-toggle="modal" data-target="#addModal">线下金额录入</button>
                        </div>
                    </div>
                    <?php }?>
                    <div class="col-lg-2">
                        <h5>今日线下总金额 ：<?php echo $sum; ?>元</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
                ...
                $status_name = AdminofflineModel::enum_status_text($v['status']);
                ?>
                <tr>
