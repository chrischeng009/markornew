                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-1">
                        ...
                        <div class="col-lg-1">
                            <h5>下单价区间</h5>
                            <div class="form-group">
                                <input type="text"  class="form-control" name="startprice" value="<?php echo $_GET['startprice']; ?>" placeholder="开始价格" />
                                <input type="text" class="form-control" name="lastprice" value="<?php echo $_GET['lastprice']; ?>"placeholder="结束价格" />
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <h5>分页条数</h5>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="form-group">
                            ...
                            <?php if($_SESSION['role_id']==1){?>
                            <a target="_blank" href="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/export2.html?<?php echo http_build_query($_GET);?>" class="btn btn-danger">外放单导出</a>
                            <?php }?>
            ...
            <div class="panel panel-default">
                <div class="panel-body table-responsive">
                    <table class="table table-hover">
                        <thead>
                        <tr >
                            <td>今日总金额 ：<font> <?php if($_SESSION['role_id']==1 && $_SESSION['admin_id']!=21  || $_SESSION['role_id']==5){?><?php echo $todypayprice+$todywithout_price; }else{?><?php echo $todypayprice+$todywithin_price; }?></font></td>
                            ...
                            <?php }?>
                            <td>今日退款总金额 ：<font> <?php if($_SESSION['role_id']==1 && $_SESSION['admin_id']!=20 ){?><?php echo $todyrefund+$todyrefundwithout_price; }else{?><?php echo $todyrefund+$todyrefundwithin_price; }?></font></td>
