                ...
                <div class="panel panel-default" style="padding-top:15px;">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="category_id">
                                    ...
                                    <option value="<?php echo $vv['id']; ?>">|______<?php echo $vv['name']; ?></option>
                                    <?php } }}?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" style="height:600px;" id="content" name="content"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
