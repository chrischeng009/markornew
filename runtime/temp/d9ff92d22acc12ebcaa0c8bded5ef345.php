                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="form-group">              
                            <select class="form-control" name="category_id">
                                ...
                                <option value="<?php echo $vv['id']; ?>" <?php if($vv['id']==$_GET['category_id']){ echo 'selected';}?>>|______<?php echo $vv['name']; ?></option>
                                <?php } }}?>
                            </select>
                        </div>
                    </div>
        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
                ...
                $flag_name = BannerModel::enum_flag_text($v['flag']);
                ?>
                <tr>
                    <td><?php echo $v['id']; ?></td>
                    ...
                    <td>
                        ...
                        <a href="javascript:;" onclick="javascript:copy(<?php echo $v['id']; ?>);"><span class="label label-success">复制</span></a>
    ...
    function copy(id){
        if(confirm('确定复制吗!')){
            $.ajax({
                type:'POST',
                cache:false,
                url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_copy.html',
                dataType:'text',
                data:"id="+id,
                success:function(data){
                    if(data=='success'){
