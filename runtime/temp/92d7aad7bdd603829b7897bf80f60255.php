        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td><?php echo $find_tearch['name']; ?></td>
                    <td><?php echo $v['mobile']; ?></td>
                    <td><?php echo $v['money']; ?></td>
                    <td><?php echo $v['loans_money']; ?></td>
                    <td><?php echo $v['freeze_money']; ?></td>
                    <td><?php echo $v['worktime']; ?></td>
                    <td><?php echo $v['worknum']; ?></td>
                    <td><a href="/home.php/<?php echo $module; ?>/task/lists.html?merchant_id=<?php echo $v['id']; ?>&abc=1"><?php echo $dayArr['count']; ?>-<?php echo $dayArr['count_order']; ?></a></td>
                    <td><?php echo $shopStrName; ?></td>
                    ...
                    <td>
                        ...
                        <a href="/home.php/<?php echo $module; ?>/merchantwithout/lists.html?merchant_id=<?php echo $v['id']; ?>&abc=1"><span class="label label-success">服务费</span></a>
                        <a href="/home.php/<?php echo $module; ?>/merchantmlogs/lists.html?merchant_id=<?php echo $v['id']; ?>&abc=1"><span class="label label-danger">财务</span></a>
                    </td>
                </tr>
                <?php }?>
            </tbody>
