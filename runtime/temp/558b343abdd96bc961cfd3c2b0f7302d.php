          ...
          <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-lg-2">
                        <h5>操作</h5>
                        <div class="form-group">              
                            <a href="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/add.html" class="btn btn-default">新增</a>
                        </div>
                    </div>
                    </form>
                </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/add.html?id=<?php echo $v['id']; ?>"><span class="label label-success">添加子级</span></a>
                ...
                <tr>
                    ...
                    <td>|______<?php echo $vv['name']; ?></td>
                    <td>
                        <a href="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/edit.html?id=<?php echo $vv['id']; ?>"><span class="label label-primary">编辑</span></a>
                        <a href="javascript:;" onclick="javascript:del(<?php echo $vv['id']; ?>);"><span class="label label-danger">删除</span></a>
                    </td>
                </tr>
                <?php } }}?>
            </tbody>
