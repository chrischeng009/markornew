...
<div class="content">
    ...
    <div class="container-padding">
        <div class="row">
            <form class="form-horizontal" method="post" id="dx_form" autocomplete="off">
            <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3" style="padding-top:7px;">
                                <?php echo $find['admin_name']; ?>
                            </div>
                            <label class="col-sm-2 control-label form-label">旧密码</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="password" class="form-control" name="comfirm_password2">
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    $("#sub").on('click',function(){
        $.ajax({
            type:'POST',
            cache:false,
            url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_edit_password.html',
            dataType:'text',
