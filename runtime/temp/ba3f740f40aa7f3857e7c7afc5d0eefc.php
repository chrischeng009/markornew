<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"./application/admin/view/order/lists2.html";i:1567678819;s:61:"/www/wwwroot/nouser/application/admin/view/common/header.html";i:1568000924;s:59:"/www/wwwroot/nouser/application/admin/view/common/menu.html";i:1562208198;s:61:"/www/wwwroot/nouser/application/admin/view/common/footer.html";i:1561019635;s:59:"/www/wwwroot/nouser/application/admin/view/order/edit2.html";i:1566111556;s:63:"/www/wwwroot/nouser/application/admin/view/order/tuikuansh.html";i:1566111556;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8"> 
        ...
        <div class="col-md-12">
          <div class="panel panel-default">
                <div class="panel-body">
                    <form action="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/lists2.html" method="get" autocomplete="off">
                        <?php if($_SESSION['role_id']==1){?>
                        <div class="col-lg-1">
                        <h5>所属业务员</h5>
                    ...
                    <div class="col-lg-1">
                        ...
                        <div class="form-group">              
                            <select class="form-control" name="status2">
                                ...
                                <option value="<?php echo $k; ?>" <?php if($k==$_GET['status2']){ echo 'selected';}?>><?php echo $v; ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <td >所属业务员</td>
                <td >所属客服</td>
                <td style="<?php if($_SESSION['role_id']!=1){ echo 'display:none';}?>" >退款是否符合要求</td>
                <td style="<?php if($_SESSION['role_id']!=1){ echo 'display:none';}?>" >退款不符合备注</td>
                <td>操作</td>
              </tr>
            </thead>
            <tbody>
                ...
                $tuikuansh_name = OrderModel::enum_tuikuansh_text($v['tuikuansh']);
                if(!empty($v['aid'])){
                ...
                <tr>
                    ...
                    <td><?php echo $status2_name; ?></td>
                    <td><?php echo $v['exceptioninfo']; ?></td>
                    <td ><?php echo $find_teacher['name']; ?></td>
                    <td ><?php echo $find_server['name']; ?></td>
                    <td style="<?php if($_SESSION['role_id']!=1){ echo 'display:none';}?>"><?php echo $tuikuansh_name; ?></td>
                    <td style="<?php if($_SESSION['role_id']!=1){ echo 'display:none';}?>"><?php echo $v['tuikuanshremark']; ?></td>
                    <td>
                        <?php if($v['status2']==1){?>
                        <a href="javascript:;" onclick="javascript:edit2(<?php echo $v['id']; ?>,3);"><span class="label label-danger">通过</span></a>
                        <a href="javascript:;" onclick="javascript:edit2(<?php echo $v['id']; ?>,2);"><span class="label label-warning">拒绝</span></a>
                        <?php }?>
                        <a href="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/view.html?id=<?php echo $v['id']; ?>"><span class="label label-info">详情</span></a>
                        <?php if($_SESSION['role_id']==1 && $v['status2']==3){?>
                        <a href="javascript:;" onclick="javascript:tuikuansh(<?php echo $v['id']; ?>);"><span class="label label-default">审核</span></a>
                        <?php }?>
                    </td>
                </tr>
                <?php }?>
        ...
        <div class="modal-body">
            ...
            <div class="col-md-12">
                <div class="panel panel-default" style="padding-top:15px;">
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">退款信息</label>
                            <div class="col-sm-8">
...
<script type="text/javascript">
    function edit2(id,status2){
        $("#editBtn").click();
        $("[name=id]").val(id);
        $("[name=status2]").val(status2);
        $.ajax({
            type:'POST',
            cache:false,
    ...
    $("#sub").on('click',function(){
        $.ajax({
            type:'POST',
            cache:false,
            url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_edit2.html',
            dataType:'text',
            data:$("#dx_form").serialize(),
            success:function(data)
            {
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="radio" name="tuikuansh" value="<?php echo $k; ?>" <?php if($k==1){ echo 'checked';}?> style="margin:0px;height:15px;" ><?php echo $v; }?>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $("#sub8").on('click',function(){
        $.ajax({
            type:'POST',
            cache:false,
            url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_tuikuansh.html',
            dataType:'text',
