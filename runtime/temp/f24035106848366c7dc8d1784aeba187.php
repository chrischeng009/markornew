<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:41:"./application/admin/view/admin/lists.html";i:1565432639;s:61:"/www/wwwroot/nouser/application/admin/view/common/header.html";i:1568000924;s:59:"/www/wwwroot/nouser/application/admin/view/common/menu.html";i:1562208198;s:61:"/www/wwwroot/nouser/application/admin/view/common/footer.html";i:1561019635;s:57:"/www/wwwroot/nouser/application/admin/view/admin/add.html";i:1561019636;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8"> 
                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-2">
                        ...
                        <div class="form-group">              
                            <input type="text" class="form-control" name="admin_name" value="<?php echo $_GET['admin_name']; ?>">
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <h5>昵称</h5>
          ...
          <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $find_role['name']; ?></td>
                    <td><?php echo $v['qq']; ?></td>
                    <td><?php echo $v['weixin']; ?></td>
                    <td><a href="javascript:;" onclick="javascript:imger('<?php echo urlencode($v['qrcode']);?>');"><img src="<?php echo $v['qrcode']; ?>" style="height:32px;"/></a></td>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">
                                <input name="auths[]" value="<?php echo $auth_name; ?>" type="checkbox" style="height:15px;"><?php echo $v['name']; ?>
                            </label>
                            <div class="col-sm-8" style="padding-top:7px;">
                                <?php if($child){ foreach($child as $vv){ $child_auth_name = $vv['control']."-".$vv['action']; ?>
                                <input name="auths[]" value="<?php echo $child_auth_name; ?>" type="checkbox" style="height:15px;"><?php echo $vv['name']; } }?>
                            </div>
                        </div>
                        <?php }?>
                        <div class="form-group">
