...
<div class="content">
    ...
    <div class="container-padding">
        <div class="row">
            <form action="/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_edit_self.html" class="form-horizontal" method="post" id="dx_form" autocomplete="off" enctype="multipart/form-data">
            <div class="col-md-12">
                <div class="panel panel-default" style="padding-top:15px;">
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">用户名</label>
                            <div class="col-sm-3" style="padding-top:7px;"><?php echo $find['admin_name']; ?></div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">打标账号：</label>
                            <div class="col-sm-3">
                                <input class="form-control" name="dbusername" value="<?php echo $find['dbusername']; ?>">
                            </div>
                            <label class="col-sm-2 control-label form-label">打标密码：</label>
                            <div class="col-sm-3">
                                <input class="form-control" name="dbpassword" value="<?php echo $find['dbpassword']; ?>" />
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    $("#sub").on('click',function(){
        $.ajax({
            type:'POST',
            cache:false,
            url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_edit_self.html',
            dataType:'text',
