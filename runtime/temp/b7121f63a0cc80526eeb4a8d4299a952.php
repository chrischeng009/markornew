          ...
          <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-lg-4">
                        <h5>任务情况</h5>
                        <div class="form-group">
                            合计任务数：<?php echo $counttask; ?>  |  总订单数：<?php echo $countorder; ?>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><?php echo $v['tasksn']; ?></td>
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><?php  echo date('Y-m-d H:i:s',$v['intime']).'(任务开始领取时间：'.date('Y-m-d H:i:s',$v['worktime']).')';?></td>
                    <td style="display:none;" <?php if($v['worktype']==2){?>style="color:red" <?php }?>><?php echo $find_teacher['name']; ?></td>
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><?php echo $find_shop['name']; ?><br/>(旺旺号：<?php echo $find_shop['wangwang']; ?>)</td>
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><a href="javascript:;" onclick="javascript:imger('<?php echo urlencode($v['mainimage']);?>');"><img src="<?php echo $v['mainimage']; ?>" style="height:30px;"/></a></td>
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><a href="<?php echo $v['goodsurl']; ?>" target="_blank"><?php echo $v['goodstitle']; ?></a></td>
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><?php echo $v['money']; ?>/<?php echo $v['num']; ?>/<?php echo $v['without_money']; ?></td>
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><?php echo $v['present']; ?></td>
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><?php echo $orderArr['money']; ?>/<?php echo $orderArr['num']; ?>/<?php echo $orderArr['without_money']; ?></td>
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><?php echo round($v['money']-$orderArr['money'], 2)?>/<?php echo $v['num']-$orderArr['num']; ?></td>
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><?php echo $status_name; ?></td>
                    <td <?php if($v['worktype']==2){?>style="color:red" <?php }?>><?php echo $worktype_name; ?></td>
                    <td >
                        ...
                        <?php if($v['status']==2){?>
                        <a href="javascript:;" onclick="javascript:edit_status3(<?php echo $v['id']; ?>);"><span class="label label-success">通过</span></a>
                        <a href="javascript:;" onclick="javascript:edit_status4(<?php echo $v['id']; ?>);"><span class="label label-warning">拒绝</span></a>
                        ...
                        <a href="javascript:;" onclick="javascript:edit_shelf(<?php echo $v['id']; ?>);"><span class="label label-info">发布</span></a>
                        <?php }?>
                        <!--<a href="javascript:;" onclick="javascript:add_task(<?php echo $v['id']; ?>);"><span class="label label-info">复制</span></a>-->
                    </td>
                </tr>
                <?php }?>
            </tbody>
    ...
    function edit_status3(id){
        if(confirm('确定操作吗!')){
            $.ajax({
                type:'POST',
                cache:false,
                url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_edit_status3.html',
                dataType:'text',
                data:"id="+id,
    ...
    function edit_status4(id){
        if(confirm('确定操作吗!')){
            $.ajax({
                type:'POST',
                cache:false,
                url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_edit_status4.html',
                dataType:'text',
                data:"id="+id,
                success:function(data){
                    if(data=='success'){
    ...
    function edit_shelf(id){
        if(confirm('确定操作吗!')){
            $.ajax({
                type:'POST',
                cache:false,
                url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_edit_shelf.html',
                dataType:'text',
                data:"id="+id,
                success:function(data){
                    if(data=='success'){
