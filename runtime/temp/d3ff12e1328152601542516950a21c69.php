<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:52:"./application/admin/view/merchantrecharge/lists.html";i:1566280963;s:61:"/www/wwwroot/nouser/application/admin/view/common/header.html";i:1568000924;s:59:"/www/wwwroot/nouser/application/admin/view/common/menu.html";i:1562208198;s:61:"/www/wwwroot/nouser/application/admin/view/common/footer.html";i:1561019635;s:70:"/www/wwwroot/nouser/application/admin/view/merchantrecharge/edit3.html";i:1561428782;s:69:"/www/wwwroot/nouser/application/admin/view/merchantrecharge/edit.html";i:1566281282;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td><?php echo $find_admin['name']; ?></td>
                    <td><?php echo $find_merchant['mobile']; ?></td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="javascript:;" onclick="javascript:edit3(<?php echo $v['id']; ?>,2);"><span class="label label-success">通过</span></a>
                        <a href="javascript:;" onclick="javascript:edit(<?php echo $v['id']; ?>,3);"><span class="label label-warning">拒绝</span></a>
                        <?php }?>
                    </td>
                </tr>
                <?php }?>
...
<script type="text/javascript">
 ...
 <button class="btn btn-default" data-toggle="modal" id="editBtn" data-target="#editModal" style="display:none;">审核编辑</button>
                ...
                <div class="panel panel-default" style="padding-top:15px;">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8" style="color: #d24e22;">
                               请再三确认后点击提交
                            </div>
                            </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">充值金额确认</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="money" value="" >
                            </div>
                            </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">备注信息</label>
                            <div class="col-sm-8">
...
<script type="text/javascript">
 ...
 <button class="btn btn-default" data-toggle="modal" id="editBtn2" data-target="#editModal2" style="display:none;">拒绝编辑</button>
