            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if($v['status']!==2){?>
                        <a href="javascript:;" onclick="javascript:edit_status(<?php echo $v['id']; ?>,2);"><span class="label label-success">通过</span></a>
                        <a href="javascript:;" onclick="javascript:edit_status(<?php echo $v['id']; ?>,3);"><span class="label label-warning">未过</span></a>
                        <?php }?>
                    </td>
                </tr>
                <?php }?>
    ...
    function edit_status(id,status){
        if(confirm('确定操作吗!')){
            $.ajax({
                type:'POST',
                cache:false,
                url:'/home.php/<?php echo $module; ?>/<?php echo $control; ?>/act_edit_status.html',
                dataType:'text',
