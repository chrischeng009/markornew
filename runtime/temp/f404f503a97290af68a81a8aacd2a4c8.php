<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:42:"./application/admin/view/within/lists.html";i:1561019637;s:61:"/www/wwwroot/nouser/application/admin/view/common/header.html";i:1568000924;s:59:"/www/wwwroot/nouser/application/admin/view/common/menu.html";i:1562208198;s:61:"/www/wwwroot/nouser/application/admin/view/common/footer.html";i:1561019635;s:58:"/www/wwwroot/nouser/application/admin/view/within/add.html";i:1561019637;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8"> 
        ...
        <div class="panel-body table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $v['id']; ?></td>
                    <td><?php echo $v['start']; ?>元-<?php echo $v['end']; ?>元</td>
        ...
        <div class="modal-body">
            ...
            <div class="col-md-12">
                <div class="panel panel-default" style="padding-top:15px;">
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">价格区间</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="start" value="">
                            </div>
                            <div class="col-sm-2" style="padding-top:7px;text-align:center;">至</div>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="end" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label form-label">佣金</label>
                            <div class="col-sm-8">
