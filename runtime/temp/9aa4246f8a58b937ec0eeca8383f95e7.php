          ...
          <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if($v['status']==1){?>
                        <a href="javascript:;" onclick="javascript:edit(<?php echo $v['id']; ?>,2);"><span class="label label-success">通过</span></a>
